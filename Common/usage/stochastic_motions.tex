...
user will be asked to enter values for a number of parameters that are used to generate
a seismic event. In the current
...
will be generated for each run based. The backend
