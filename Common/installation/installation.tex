...
Note: If you already have a Python installation that is Python 2.7 or newer, you do not 
have to install Anaconda to work with SimCenter
...
dated version 2.7. You need to ensure that the following packages:
\texttt{numpy}, \texttt{scipy}, and \texttt{pandas} are installed. To install 
these packages, start a terminal window and type:
...
\item If you have installed Python3 on your system, in the preceeding replace pip with pip3.
Also in the tools preferences replace Python executable with Python3.
\end{enumerate}
\end{enumerate}
