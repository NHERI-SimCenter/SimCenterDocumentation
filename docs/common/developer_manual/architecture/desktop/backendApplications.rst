...
The backend applications are categorized by function into the following workflow |term1| which create and populate *intermediate files* used to propogate information from one component application to the next. The |term1| and their intermediate files are as follows:
