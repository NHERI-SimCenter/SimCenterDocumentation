...
The first panel :numref:`figResultsSumaryPBE` shows summary statistics: mean, standard deviation, and several important percentiles of the Decision Variables.
