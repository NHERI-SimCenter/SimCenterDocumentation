    ...
    .. dropdown:: Version 3.1.0 (:blue:`Current`)
        ...
        **User Interface**
            ...
            1. **Settings**:
                ...
                * Added a settings panel for setting simulation parameters (e.g. time step, characteristic length, domain size, CFL number).
                * Added a settings panel for setting computer parameters (e.g. number of cores, number of GPUs, etc.).
                * Added a settings panel for setting similitude parameters (e.g. Froude scale, Cauchy scale, etc.).
            ...
            2. **Bodies**:
                ...
                #. **Material**: 
                    ...
                    a. Supports ``elastic``, ``hyperelastic``, and ``elasto-plastic`` material models.
                    
                    b. New constitutive laws:
            ...
            5. **Outputs**:
                ...
                Collection of simulation settings that does not effect the simulation itself, but rather the output it gives to the user.
        ...
        **DesignSafe Support and Hardware**
            ...
            * Updated support for the TACC Frontera supercomputer:
                ...
                a. Access the ``rtx`` queue. Includes 4 NVIDIA RTX Quadro 5000 GPUs (16GB memory each).
