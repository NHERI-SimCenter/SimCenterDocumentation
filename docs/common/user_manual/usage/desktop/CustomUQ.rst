...
Custom Uncertainty Quantification Engine Input
*******************************************************

This option enables users to switch out the UQ engine in the quoFEM workflow
such that different methods and tools can be applied within the SimCenter
...
* *Combo Box*: Allows selection of a particular option from a specified set
...
Lastly, users must specify the UQ driver name. This is required to direct the customized UQ
backend to the correct UQ driver. The driver name must correspond the name provided in the
customized backend, as described below.
