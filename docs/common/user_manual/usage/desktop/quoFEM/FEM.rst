...
The FEM panel will present users with a selection of FEM applications. Currently, there are three applications available: OpenSees, FEAPpv and OpenSeesPy. More FE platforms will be added in future versions to allow users to provide their own simulation application.
...
.. note:
   ...
   No parameters file need be specified. If this is the case, the python script must specify the random variables in the main script in the following form
