...
**Version 3.2** of |app| was released **Sept 22**. The following lists the functionality available in this current version.

.. note::

       New features and fixes in this release that were not present in previous release are denoted with a blue font color
