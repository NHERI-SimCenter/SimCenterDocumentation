...
\title{     {\fontfamily{qhv}\selectfont \textbf{\textit{s$^3$hark  }} }       \\ A Research Tool for Studying the Site Specific Response to Earthquakes}
...
\softwarename{{\fontfamily{qhv}\selectfont \textit{s$^3$hark}}}
...
\chapter{About}
\label{chap:about}
\input{about/about_s3hark.tex}

\chapter{Installation Instructions}
\label{chap:installation}
\input{installation/installation_s3hark.tex}

\chapter{Usage}
\label{chap:usage}
\input{usage/s3hark_app.tex}

\chapter{Theory and Implementation}
\label{chap:theory}
\input{theory_and_implementation/theory_and_implementation_s3hark.tex}
...
\label{chap:vnv}
\input{ver_and_val/s3hark_verification.tex}
