...
Examples included in this document are based on the \href{https://simcenter.designsafe-ci.org/media/filer_public/a0/68/a068ba45-6a47-46f4-83b1-fae585d8ccbe/evw_documentation.pdf}{\textit{User Manual}} provided on the \getsoftwarepage{\texttt{\getsoftwarename{}} application webpage}.
...
%\begin{figure}[H]
%	\centering \includegraphics[width=0.55\linewidth]{SAC_moment_frame_LA.pdf}
%	\caption{Floor plans showing layout of moment-resisting frames for LA model buildings \cite{FEMA335c2000}.}
%	\label{fig:MRF_LASE}
%\end{figure}
...
\bottomrule
\multicolumn{3}{l}{\footnotesize $^{1)}$ For approximate natural frequencies, see section 26.11.2 and C26.11 of the ASCE 7-16. For this example, since the}	\\
\multicolumn{3}{l}{\footnotesize \hspace{3mm} building is designed and the properties of the building elements are known, the natural frequency is accurately calculated.}	\\
...
Chopra, 4th ed. \cite{ChopraAnilK2012Dos}}
\end{tabular}}
\end{table}

\noindent\textbf{Procedure}\\
In order to use the \getsoftwarepage{\texttt{\getsoftwarename{}} app}, input forces and building properties need to be known. For gust wind speed, the gust-effect factor should be computed based on the location and function of the building according to the Chapter 26 of \cite{asce7_2016}. This is shown in \cref{tab:gust_factor_3LA250}.
...
\noindent\textbf{Procedure}\\
\indent As in the previous example, in order to use the \getsoftwarepage{\texttt{\getsoftwarename{}} app}, input forces and building properties need to be known. The gust-effect factor is calculated as shown in \cref{tab:gust_factor_3SE250}.
...
\noindent\textbf{Procedure}\\
\indent As in the previous example, in order to use the \getsoftwarepage{\texttt{\getsoftwarename{}} app}, input forces and building properties need to be known. The gust-effect factor is calculated as shown in \cref{tab:gust_factor_20LA250}.
...
\noindent\textbf{Procedure}\\
\indent As in the previous example, in order to use the \getsoftwarepage{\texttt{\getsoftwarename{}} app}, input forces and building properties need to be known. \cref{tab:gust_factor_20SE250} shows gust-effect factor calculations.
...
\noindent\textbf{Procedure}\\
\indent As in the previous example, in order to use the \getsoftwarepage{\texttt{\getsoftwarename{}} app}, input forces and building properties need to be known. \cref{tab:gust_factor_8_story_bldg} shows gust-effect factor calculations.
