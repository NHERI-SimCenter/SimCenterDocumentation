...
\begin{figure}[!htbp]
  ...
  \caption{The \texttt{\getsoftwarename{}} user interface after loading the application.}
  \label{fig:app_UI}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{Adding \texttt{OpenSees} to the PATH environment variable on Windows.}
...
\begin{figure}[!htbp]
  ...
  \caption{Adding \texttt{OpenSees} to the PATH environment variable on Mac.}
...
\begin{figure}[!htbp]
  ...
  \caption{Testing \texttt{OpenSees}.}
