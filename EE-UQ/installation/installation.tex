...
\begin{figure}[!htbp]
  \centering {
    ...
    {installation/figures/applicationDownload.png} }
...
Following the instructions provided for installing  \texttt{OpenSees}, you need to add TWO \texttt{Dakota} folders to the
system \texttt{PATH} environment variable to allow the SimCenter
