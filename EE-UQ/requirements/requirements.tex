    ...
    \begin{adjustbox}{max width=0.7\textwidth}            
      \begin{tabular}{lll}                    
        \toprule          
          ...
          2.0   & March 2019     &	 2.7a, 2.8a, 3.6, 6.3, 8.1\\
                &                &   9.1b, 9.3e-f\\ \hline
          2.1   & May 2019       &	 2.7b\\ 
                &                &   9.3g, 10.1\\  \hline
          3.0   & September 2019 &   2.6, 2.7c, 2.7d, 2.8b, 3.2, 4.3, 4.4\\
                &                &   6.2, 6.3, 8.2\\
                &                &   9.1c-e, 9.4d\\ \hline
      \end{tabular}
    \end{adjustbox}
    ...
    \begin{adjustbox}{max width=\textwidth}            
      \begin{tabular}{lll}                    
        \toprule          
          ...
          1.2	 & May  2019      &	2.7b\\  \hline
          2.0    & June 2019      & 4.3, 6.2, 8.2, 9.1\\ \hline
          3.0	 & September 2019 &	2.6, 2.7c, 2.7d, 2.8b, 3.2, 4.4, 6.2, 6.3\\  \hline
      \end{tabular}
    \end{adjustbox}
      \caption{Schedule of Release}             
      \label{tab:schedule}                 
